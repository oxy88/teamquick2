...
class OneOnOneEventDetailsScreen extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            isTournament: true
    ...
    render() {
        return (
            <Container>
                <EventHeader navigation={this.props.navigation} title="은평구 풋살해용"/>
            <Content>
...
export default OneOnOneEventDetailsScreen